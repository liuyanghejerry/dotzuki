...
fn generate_ruleset_with_imports(ruleset: &RulesetInput) -> TokenStream {
    ...
    quote! {
        {
            use jrpg_rules::{Ruleset, TypeChartEntry, Rational, EffectRecord, EffectKind, HookRecord, ResourceCost, Op, Predicate, Selector, FractionOf, DamageValue, HitCount, FinalHitRider};
