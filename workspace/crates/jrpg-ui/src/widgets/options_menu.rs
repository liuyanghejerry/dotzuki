...
mod tests {
    ...
    fn box_configs() -> [MenuConfig; 4] {
        [
            MenuConfig::new(TileRect::new(2,2,16,3), None, TileRect::new(3,3,14,1), jrpg_engine::menu::CursorStyle::new(None, Default::default())),
            MenuConfig::new(TileRect::new(2,5,16,3), None, TileRect::new(3,6,14,1), jrpg_engine::menu::CursorStyle::new(None, Default::default())),
            MenuConfig::new(TileRect::new(2,8,16,3), None, TileRect::new(3,9,14,1), jrpg_engine::menu::CursorStyle::new(None, Default::default())),
            MenuConfig::new(TileRect::new(2,11,16,3), None, TileRect::new(3,12,14,1), jrpg_engine::menu::CursorStyle::new(None, Default::default())),
        ]
    }
