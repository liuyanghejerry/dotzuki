...
mod tests {
    ...
    fn list_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(4,12,16,6), None, TileRect::new(5,13,14,4), jrpg_engine::menu::CursorStyle::new(Some(223), Default::default()))
    }
    fn pp_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(0,8,11,5), None, TileRect::new(1,9,9,3), jrpg_engine::menu::CursorStyle::new(None, Default::default()))
    }
