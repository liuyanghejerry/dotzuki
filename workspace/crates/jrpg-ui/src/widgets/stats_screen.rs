...
use jrpg_engine::render::{Frame, Rgba, Painter, Ui};
...
mod tests {
    ...
    fn main_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(6,0,14,18), None, TileRect::new(7,1,12,16), jrpg_engine::menu::CursorStyle::new(None, Default::default()))
    }
    fn stats_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(6,10,10,9), None, TileRect::new(7,11,8,7), jrpg_engine::menu::CursorStyle::new(None, Default::default()))
    }
    fn moves_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(6,10,12,11), None, TileRect::new(7,11,10,9), jrpg_engine::menu::CursorStyle::new(None, Default::default()))
    }
