...
mod tests {
    ...
    fn info_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(3,2,14,14), None, TileRect::new(4,3,12,12), jrpg_engine::menu::CursorStyle::new(Some(223), Default::default()))
    }
    fn prompt_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(5,5,10,7), None, TileRect::new(6,6,8,5), jrpg_engine::menu::CursorStyle::new(None, Default::default()))
    }
