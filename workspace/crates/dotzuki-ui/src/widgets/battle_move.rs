...
mod tests {
    ...
    fn list_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(4,12,16,6), None, TileRect::new(5,13,14,4), dotzuki_engine::menu::CursorStyle::new(Some(223), Default::default()))
    }
    fn pp_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(0,8,11,5), None, TileRect::new(1,9,9,3), dotzuki_engine::menu::CursorStyle::new(None, Default::default()))
    }
    fn test_data() -> MoveMenuData {
        MoveMenuData {
            moves: vec![
                MoveEntry { name: "THUNDERBOLT".into(), pp_current: 5, pp_max: 15, disabled: false, move_type: Some("ELEC".into()) },
                MoveEntry { name: "QUICK ATTACK".into(), pp_current: 0, pp_max: 30, disabled: true, move_type: Some("NORM".into()) },
            ],
            cursor: 0,
        }
    }
