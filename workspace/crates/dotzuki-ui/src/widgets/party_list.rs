...
mod tests {
    ...
    fn list_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(0,0,20,18), None, TileRect::new(1,1,18,16), dotzuki_engine::menu::CursorStyle::new(Some(223), Default::default()))
    }
    fn action_config() -> MenuConfig {
        MenuConfig::new(TileRect::new(12,4,8,8), None, TileRect::new(13,5,6,6), dotzuki_engine::menu::CursorStyle::new(Some(223), Default::default()))
    }
    fn test_data() -> PartyListData {
        PartyListData {
            members: vec![
                PartyMemberEntry { name: "SPARKIT".into(), level: 25, hp: 60, max_hp: 60, status: None, species_icon: None, active: true },
                PartyMemberEntry { name: "LEAFKIT".into(), level: 20, hp: 10, max_hp: 50, status: Some("SLP".into()), species_icon: None, active: true },
            ],
            cursor: 0,
