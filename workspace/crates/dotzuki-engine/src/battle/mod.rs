...
//! ## Design Principles
//!
//! * **Generic over game data** — No concrete Pokémon, monster, or move types.
...
pub trait BattleProvider {
    ...
    //
    // All four are *defaulted* so pre-existing providers (and non-Pokémon
    ...
    /// non-Pokémon games keep their exact draw sequence unchanged.
    fn roll_critical(
        &self,
        _state: &BattleState<Self>,
        _who: BattlerRef,
