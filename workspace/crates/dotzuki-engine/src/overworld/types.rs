...
pub struct PlayerState {
    ...
    /// Whether biking advances at double speed (Gen-1 `DoBikeSpeedup`).
    /// Defaults to on; a game can switch it off for specific rules (e.g.
    /// the Route 17 slope cancels the speedup while the player presses
    /// UP/LEFT/RIGHT — home/overworld.asm:377-388).
