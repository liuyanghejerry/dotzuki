...
use jrpg_engine::battle::stack::Event;
...
/// engine [`EffectType`](jrpg_engine::battle::stack::EffectType); the optional
...
pub struct EffectRecord {
    ...
    /// [`EffectId`](jrpg_engine::battle::stack::EffectId) per hook at compile.
    pub id: String,
...
/// [`EffectType`](jrpg_engine::battle::stack::EffectType) AND to which provider
...
/// `target`/`source` [`BattlerRef`](jrpg_engine::battle::BattlerRef)s.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Deserialize)]
pub enum Selector {
    /// The dispatch target.
    Target,
...
pub fn parse_kind(kind: EffectKind) -> jrpg_engine::battle::stack::EffectType {
    use jrpg_engine::battle::stack::EffectType;
    match kind {
