...
//! [`Effect`](jrpg_engine::battle::stack::Effect)s + a map from the synthesized
...
use jrpg_engine::battle::stack::{Effect, EffectId, EffectProvider, EffectType, Event, EventHook};
...
pub struct CompiledRuleset {
    ...
    /// implement [`BattleProvider::move_cost`](jrpg_engine::battle::BattleProvider::move_cost)
...
impl CompiledRuleset {
    ...
    /// the binding) to build [`BattleProvider::move_cost`](jrpg_engine::battle::BattleProvider::move_cost).
