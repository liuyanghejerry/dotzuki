...
use jrpg_engine::render::{Rgba, TilePos};
...
pub fn render_tile_with_tiles(
    ...
    fb: &mut jrpg_engine::render::FrameBuffer,
) -> Result<(), RenderError> {
        ...
        for col in 0..cols {
            ...
            for ty in 0..TILE_PIXELS {
                ...
                for tx in 0..TILE_PIXELS {
                    ...
                    if rgba != jrpg_engine::render::Rgba::TRANSPARENT {
...
mod tests {
    ...
    fn render_tile_with_tiles_no_flip() {
        ...
        let mut fb = jrpg_engine::render::FrameBuffer::new(jrpg_engine::render_config::RenderConfig::new(160, 144), jrpg_engine::render::Rgba::WHITE);
