...
fn asset_for(kind: IconKind, frame: IconFrame) -> IconAsset {
    match (kind, frame) {
        ...
        (IconKind::Water, _) => IconAsset { category: "sprites", filename: "seel.png", start_tile: 0, tile_count: 4 },
        (IconKind::Ball, _) => IconAsset { category: "sprites", filename: "poke_ball.png", start_tile: 0, tile_count: 4 },
        (IconKind::Helix, _) => IconAsset { category: "sprites", filename: "poke_ball.png", start_tile: 0, tile_count: 4 },
...
mod tests {
    ...
    fn draw_mon_icon_respects_transparent_color0() {
        let mut fb = FrameBuffer::new(jrpg_engine::render_config::RenderConfig::new(160, 144), Rgba::BLACK);
