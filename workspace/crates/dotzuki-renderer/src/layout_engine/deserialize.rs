...
mod tests {
    ...
    // ── test_parse_pokedex_layout ─────────────────────────────────────

    #[test]
    fn test_parse_pokedex_layout() {
        let json = r##"{
            "schema_version": 1,
            "screen": "pokedex",
            "theme": { "bg_color": "#FFFFFF", "default_font": "default" },
        ...
        let layout = parse_layout(json).expect("pokedex layout should parse");
        assert_eq!(layout.screen, "pokedex");
    ...
    fn test_parse_custom_element() {
        ...
        assert_eq!(layout.elements.len(), 1);
        assert_eq!(layout.elements[0].element_type, "custom:pokemon_sprite");
    }
