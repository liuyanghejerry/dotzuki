...
impl DslSceneRegistrar for jrpg_engine_script::loader::ScriptLoader {
...
/// Register all DSL-compiled scenes with a `jrpg-engine-script` `ScriptLoader`.
pub fn register_dsl_scenes(loader: &mut jrpg_engine_script::loader::ScriptLoader) {
