...
use jrpg_engine_dsl::ast::{Document, PropKind};
use jrpg_engine_dsl::codegen::json_ui;
use jrpg_engine_dsl::lexer::Lexer;
use jrpg_engine_dsl::parser::{self, ParseError, Parser};

fn lex(src: &str) -> Vec<jrpg_engine_dsl::lexer::SpannedToken> {
