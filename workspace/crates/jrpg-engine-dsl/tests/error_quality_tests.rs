...
use jrpg_engine_dsl::ast::SourceSpan;
use jrpg_engine_dsl::error::{to_miette_span, DslError};
use jrpg_engine_dsl::lexer::{Lexer, LexError, SpannedToken, Token};
use jrpg_engine_dsl::parser::{ParseError, SemanticError};
...
fn parse_and_validate(
    ...
    Option<jrpg_engine_dsl::ast::Document>,
    Vec<ParseError>,
    Vec<SemanticError>,
) {
    jrpg_engine_dsl::parser::parse_and_validate(tokens, "")
}
...
fn parse_only(
    ...
    jrpg_engine_dsl::parser::parse(tokens)
}
