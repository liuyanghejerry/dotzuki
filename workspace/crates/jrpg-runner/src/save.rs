...
//!
//! The save lives at `<project>/.jrpg-save.json` (a dotfile in the project
...
//! slot/CRC16 framework (`jrpg_engine::save`): one file, human-readable,
...
pub const DEFAULT_SAVE_FILE: &str = ".jrpg-save.json";
