...
//!
//! [`LoadedProject::load`] reads the `.jrpg-editor.json` manifest, compiles
...
use jrpg_engine_dsl::compiler::{compile_files, CompileReport, RouteEntry, DSL_EXTENSIONS};
use jrpg_engine_dsl::loader::register_compiled;
use jrpg_engine_script::loader::ScriptLoader;
...
const MANIFEST_FILE: &str = ".jrpg-editor.json";
...
impl LoadedProject {
    ...
    /// `.jrpg-editor.json`) from disk. Convenience for
    ...
    /// The parsed `.jrpg-editor.json` manifest.
    #[inline]
