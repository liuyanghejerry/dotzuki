...
//!
//! A game project is a directory with a `.jrpg-editor.json` manifest, a
...
//!
//! - [`manifest`] — serde model of `.jrpg-editor.json`;
...
//!   scene VM + dialogue/choice UI), implementing `jrpg_app::GameLoop` for
...
//!   scene audio commands (jrpg-audio APU + cpal; silent when a project has
...
//!   `<project>/.jrpg-save.json`, written at stable overworld points.
