...
// behaves today. `pkgDir` selects the wasm-pack --out-dir (jrpg-web ships both
...
stagePkg(
  'jrpg-web', 'jrpg_web.js', 'jrpg_web_bg.wasm',
  'wasm-pkg', 'pnpm build:wasm', 'WASM preview pkg',
)
stagePkg(
  'jrpg-runner-web', 'jrpg_runner_web.js', 'jrpg_runner_web_bg.wasm',
