...
const GUI_COMPONENTS = new Set([
  ...
  'cursor', 'bracket', 'pixel_rect', 'group',
])
...
const GUI_PROPERTIES = new Set([
  ...
  // primitives / cursor / theme
  'position', 'col', 'row', 'col_step', 'row_step', 'glyph', 'with_arrow',
  'left', 'right', 'top', 'bottom', 'width', 'height', 'field', 'prefix',
])
