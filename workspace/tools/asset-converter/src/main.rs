...
struct Cli {
    ...
    #[arg(short, long, required_unless_present_any = ["all", "all_pokemon"])]
    ...
    /// Alias for `--all` (for compatibility with the --all-pokemon workflow)
    #[arg(long = "all-pokemon", default_value_t = false)]
    all_pokemon: bool,
}
...
fn main() -> Result<(), String> {
    ...
    let is_batch = cli.all || cli.all_pokemon;
