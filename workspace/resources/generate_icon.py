#!/usr/bin/env python3
"""Generate pixel art app icon -- trainer sprite in Pokémon Red/Blue style."""
...
def draw_pokeball(px):
    """Small Poké Ball in hand."""
    # Poké ball at the right side (around x=25, y=18-23)
