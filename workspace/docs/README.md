...
| Authoring **DSL** (`.scene` scripts, `.gui` UI, `.theme`/`.style`) | [`GAME_UI_DSL.md`](./GAME_UI_DSL.md) for the implemented UI syntax; see the DSL section below for the scene side |
...
| Authoring **audio / assets** | `game-project-spec.md` §Audio (thin); asset conversion: [`asset-converter/README.md`](../tools/asset-converter/README.md) |
...
| [`game-project-spec.md`](./game-project-spec.md) | Game authors, tool implementers | Zero-Rust project manifest (`.dotzuki-editor.json`), directory layout, `dotzuki run`/`check` behavior contract, battle RON hooks, levels/EXP, save compatibility. **The most current spec.** |
...
- [`docs/`](../../docs/) (repo root) — non-engineering docs: [`marketing-plan.md`](../../docs/marketing-plan.md), [`repo-split-standalone.md`](../../docs/repo-split-standalone.md)
